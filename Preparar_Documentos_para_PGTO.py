...
if __name__ == "__main__":
    try:
        ...
        bot:Preparar = Preparar(
            date=date,
            arquivo_datas=f"C:/Users/{getuser()}/PATRIMAR ENGENHARIA SA/RPA - Documentos/RPA - Dados/Pagamentos Diarios - Contas a Pagar/Datas_Execução.xlsx",
            #dias=1 #<----- desativar para produção
            #em_massa=False
        )
        
        bot.segundo_preparar_documentos(caminho_fornecedores_pgto_T=f"C:/Users/{getuser()}/PATRIMAR ENGENHARIA SA/RPA - Documentos/RPA - Dados/Pagamentos Diarios - Contas a Pagar/")
